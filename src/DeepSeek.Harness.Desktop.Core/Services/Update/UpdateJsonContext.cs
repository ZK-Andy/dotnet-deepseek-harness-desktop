...
/// <see cref="UpdateStateMachine.ReadyRecord"/> 的序列化随类型走（B2 起 ready.json 持久化适配器在
/// Infrastructure 消费本上下文；键名 version/assetPath 与历史文件互认）。
/// </summary>
[JsonSourceGenerationOptions(
    PropertyNamingPolicy = JsonKnownNamingPolicy.CamelCase,
    GenerationMode = JsonSourceGenerationMode.Serialization)]
[JsonSerializable(typeof(UpdateStateFrame))]
[JsonSerializable(typeof(UpdateStateMachine.ReadyRecord))]
