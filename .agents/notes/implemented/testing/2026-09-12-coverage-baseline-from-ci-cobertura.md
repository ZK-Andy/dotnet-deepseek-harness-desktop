...
- 2026-09-13 第三次跟值：`34722645763`（事务化插件管线 `49234c6` 代码面）610/610、3942/7075 = 55.72%——事务新代码覆盖率高（单元覆盖充分）带动徽章回升，无异常信号。
...
- 跟值台账：2026-09-12 `3714/6725`→2026-09-13 `3782/6909`→2026-09-13 `3942/7075`→2026-09-14 `3994/7158`（CI `34778153958`，612/612、55.79%，v0.4.11 发布收尾）→2026-09-14 `4040/7306`（CI `34793499164`，B4 三工程代码面、614/614、55.30%；并集口径见 [multi-project-merge](2026-09-14-coverage-baseline-multi-project-merge.md)）→2026-09-15 `4278/7490`（CI `34961580068`，v0.5.2 发布批 = 市场接力收养优先 + 版本 bump，634/634、57.12%）→2026-09-16 `4327/7531`（CI `35027086480`，v0.5.3 发布批 = 接力就绪判据升级为 web 面可服务 + 版本 bump，641/641、57.46%）→**2026-09-16 `4359/7567`（CI `35041459046`，profile/锁路径拒符号链接 `39723d2`，656/656、57.61%）**。
